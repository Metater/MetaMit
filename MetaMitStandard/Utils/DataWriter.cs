...
{
    // Copied from: https://github.com/RevenantX/LiteNetLib/blob/master/LiteNetLib/Utils/NetDataWriter.cs
    public class DataWriter
    {
        ...
        public static DataWriter FromBytes(byte[] bytes, bool copy)
        {
            ...
            return new DataWriter(true, 0) { _data = bytes, _position = bytes.Length };
        }
